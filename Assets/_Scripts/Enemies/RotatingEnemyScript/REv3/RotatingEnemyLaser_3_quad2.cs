...
public class RotatingEnemyLaser_3_quad2 : MonoBehaviour {
	...
	void Start () {
		...
		RotatingEnemyScript_3_quad rotatingEnemyScript = rotatingEnemy.GetComponent <RotatingEnemyScript_3_quad> ();
